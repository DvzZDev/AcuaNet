    ...
    <>
      ...
      <section className="flex justify-center bg-bgcolor text-textprimary">
        ...
        >
          ...
          <h2 className="mb-2 mt-4 text-xl font-semibold">Condiciones de uso:</h2>
          <p>
          ...
          <h2 className="mb-2 mt-4 text-xl font-semibold">Propiedad intelectual:</h2>
          <p>
          ...
          <h2 className="mb-2 mt-4 text-xl font-semibold">Protección de datos:</h2>
          <p>
            Este sitio web utiliza un recolector de datos para analizar las visitas. Todos
            los demás datos del sitio son de código abierto. Los datos personales
            proporcionados a través de formularios serán tratados conforme a la normativa
            vigente en materia de protección de datos personales.
          </p>
          <h3 className="mb-2 mt-4 text-lg font-semibold">Derechos del usuario:</h3>
          <p>
          ...
          <p>
            ...
            la persona que ha contactado y su correo electrónico, utilizando un captcha
            para prevenir envíos automáticos.
          </p>
          <h3 className="mb-2 mt-4 text-lg font-semibold">Medidas de seguridad:</h3>
          <p>
          ...
          <h2 className="mb-2 mt-4 text-xl font-semibold">Modificaciones:</h2>
          <p>
          ...
          <h2 className="mb-2 mt-4 text-xl font-semibold">Enlaces:</h2>
          <p>
          ...
          <h2 className="mb-2 mt-4 text-xl font-semibold">Derecho de exclusión:</h2>
          <p>
          ...
          <h2 className="mb-2 mt-4 text-xl font-semibold">Código abierto:</h2>
          <p>
