    ...
    <>
      ...
      <section className="flex justify-center bg-green-50 text-green-950">
        ...
        >
          ...
          <h2 className="mt-4 mb-2 text-xl font-semibold text-green-700">Condiciones de uso:</h2>
          <p>
          ...
          <h2 className="mt-4 mb-2 text-xl font-semibold text-green-700">Propiedad intelectual:</h2>
          <p>
          ...
          <h2 className="mt-4 mb-2 text-xl font-semibold text-green-700">Protección de datos:</h2>
          <p>
          ...
          <h3 className="mt-4 mb-2 text-lg font-semibold text-green-700">Derechos del usuario:</h3>
          <p>
          ...
          <h3 className="mt-4 mb-2 text-lg font-semibold text-green-700">Finalidad del tratamiento de datos:</h3>
          <p>
          ...
          <h3 className="mt-4 mb-2 text-lg font-semibold text-green-700">Medidas de seguridad:</h3>
          <p>
          ...
          <h2 className="mt-4 mb-2 text-xl font-semibold text-green-700">Exclusión de garantías y responsabilidad:</h2>
          <p>
          ...
          <h2 className="mt-4 mb-2 text-xl font-semibold text-green-700">Modificaciones:</h2>
          <p>
          ...
          <h2 className="mt-4 mb-2 text-xl font-semibold text-green-700">Enlaces:</h2>
          <p>
          ...
          <h2 className="mt-4 mb-2 text-xl font-semibold text-green-700">Derecho de exclusión:</h2>
          <p>
          ...
          <h2 className="mt-4 mb-2 text-xl font-semibold text-green-700">Código abierto:</h2>
          <p>
