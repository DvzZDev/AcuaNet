    ...
    <>
      ...
      <section className="flex justify-center bg-bgcolor text-textprimary">
        ...
        >
          ...
          <h2 className="mb-2 mt-4 text-xl font-semibold text-textsecondary">Condiciones de uso:</h2>
          <p>
          ...
          <h2 className="mb-2 mt-4 text-xl font-semibold text-textsecondary">Propiedad intelectual:</h2>
          <p>
          ...
          <h2 className="mb-2 mt-4 text-xl font-semibold text-textsecondary">Protección de datos:</h2>
          <p>
          ...
          <h3 className="mb-2 mt-4 text-lg font-semibold text-textsecondary">Derechos del usuario:</h3>
          <p>
          ...
          <h3 className="mb-2 mt-4 text-lg font-semibold text-textsecondary">Finalidad del tratamiento de datos:</h3>
          <p>
          ...
          <h3 className="mb-2 mt-4 text-lg font-semibold text-textsecondary">Medidas de seguridad:</h3>
          <p>
          ...
          <h2 className="mb-2 mt-4 text-xl font-semibold text-textsecondary">Exclusión de garantías y responsabilidad:</h2>
          <p>
          ...
          <h2 className="mb-2 mt-4 text-xl font-semibold text-textsecondary">Modificaciones:</h2>
          <p>
          ...
          <h2 className="mb-2 mt-4 text-xl font-semibold text-textsecondary">Derecho de exclusión:</h2>
          <p>
          ...
          <h2 className="mb-2 mt-4 text-xl font-semibold text-textsecondary">Código abierto:</h2>
          <p>
