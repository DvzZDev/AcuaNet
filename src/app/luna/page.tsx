  ...
  return (
    <>
      <main className="justify-center">
        <h1 className="m-auto mt-4 w-fit rounded-2xl bg-black/40 px-2 text-center text-[2.5rem] font-bold text-green-100 backdrop-blur-lg sm:mt-10 sm:mb-2 sm:text-6xl md:p-3 xl:mb-0">
          Calendário Lunar
        </h1>
        <Divider />
