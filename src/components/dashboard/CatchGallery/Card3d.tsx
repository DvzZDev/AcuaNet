...
export default function Card3D({ report }: { report: CatchReportDB }) {
  ...
  return (
    <motion.div
      ...
      className="group relative h-[20rem] animate-blurred-fade-in w-full overflow-hidden rounded-2xl shadow-2xl"
    >
      <Link
