...
export default function UpperBarCliMob({ userData }: UpperBarCliMobProps) {
  ...
  const { type, suggestions, handletype, handleSuggestionClick } = AutoCompleteHook(nombreEmbalses)
        ...
        <AnimatePresence>
          {showSuggestions && (
            <motion.div
              ...
              layout
              className="absolute top-full left-0 z-30 mt-2 max-h-60 w-full overflow-y-auto rounded-lg border border-emerald-200 bg-emerald-50 shadow-lg"
            >
