export default function HistorialCambios({
  ...
  return (
    <>
      <h3 className="text-2xl font-black text-green-950">Historial de cambios</h3>
        ...
        <div className="flex flex-col gap-4 md:flex-row md:gap-10 lg:gap-32">
          <div className="flex w-full items-center gap-5 rounded-md p-2 md:w-1/3">
            ...
            <div className="flex w-full flex-col gap-2">
              ...
              <p className="text-sm font-semibold text-[#3d7764]">
                {variacion_ultima_semanapor}% de la capacidad total
              </p>
            </div>
          </div>
          {/* Hace un año */}
          <div className="flex w-full items-center gap-5 rounded-md p-2 md:w-1/3">
            ...
            <div className="flex w-full flex-col gap-2">
              ...
              <p className="text-sm font-semibold text-[#3d7764]">
                {misma_semana_ultimo_añopor}% de la capacidad total
              </p>
            </div>
          </div>
          {/* Hace 10 años */}
          <div className="flex w-full items-center gap-5 rounded-md p-2 md:w-1/3">
            ...
            <div className="flex w-full flex-col gap-2">
              ...
              <p className="text-sm font-semibold text-[#3d7764]">
                {misma_semana_10añospor}% de la capacidad total
              </p>
            </div>
          </div>
        </div>
