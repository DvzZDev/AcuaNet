...
export default function FavButton({ url }: { url: { embalseid: string } }) {
  ...
  return (
    <button
      className={`fixed right-4 top-[5rem] z-40 flex h-10 w-10 items-center justify-center rounded-full bg-[#384948] bg-opacity-80 shadow-md transition-colors ${isFavorite ? "text-yellow-400" : "text-green-200"}`}
