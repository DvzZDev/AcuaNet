      ...
      <div className="flex flex-col items-center justify-center">
        <section className="mx-6 grid h-fit max-w-[70rem] grid-cols-1 gap-10 md:grid-cols-2">
          <div className="col-span-1 flex flex-col">
            <h2 className="text-center text-[2.3rem] leading-none font-black text-[#1b7b6e] sm:text-[50px] md:text-left">
              Detras de AcuaNet
            </h2>
            ...
            <div className="flex w-full justify-center">
              <Link href="/quienesSomos">
                <button
                  ...
                  className="animate-infinite hover:animate-wiggle m-auto mt-6 rounded-lg bg-[#275e565c] p-3 text-lg font-bold text-[#1f4d46] transition-all hover:brightness-90 md:text-xl"
                >
                  ¡Conócenos!
                </button>
              </Link>
          ...
          <div className="flex items-center justify-center">
            <div className="relative">
              ...
              <div className="bg-opacity-80 absolute right-[-15px] bottom-[-70px] left-4 z-20 rounded-lg bg-[#275e568a] p-4 shadow-md sm:bottom-[-60px] md:bottom-[-50px]">
