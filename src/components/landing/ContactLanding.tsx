      ...
      <div className="flex justify-center bg-bgcolor pt-10">
        <div className="grid w-[50rem] grid-cols-2 grid-rows-2 gap-5">
          <motion.div
            ...
            whileInView="animate"
            viewport={{ once: true, amount: 0.8 }}
            className="gapy-2 flex h-full flex-col items-center justify-center rounded-md bg-slate-800 p-4 text-textprimary"
          >
          ...
          <motion.div
            ...
            whileInView="animate"
            viewport={{ once: true, amount: 0.8 }}
            className="gapy-2 flex flex-col items-center justify-center rounded-md bg-slate-800 p-4 text-textprimary"
          >
            <div className="flex justify-center">
              <svg
                xmlns="http://www.w3.org/2000/svg"
