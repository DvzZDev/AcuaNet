...
function Fuentes() {
  return (
    ...
    >
      <h2 className="text-center text-[2.3rem] leading-none font-black text-green-100 sm:text-[50px]">Fuentes Oficiales</h2>
      ...
      <div className="mt-8 flex flex-col md:flex-row md:gap-16">
        <img
          src="/aemet.webp"
          alt="Aemet España"
          className="aspect-auto h-[120px] w-[200px] object-contain"
          draggable="false"
          loading="lazy"
        />
        <img
