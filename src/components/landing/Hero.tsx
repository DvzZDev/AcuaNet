...
export default async function Hero() {
  return (
    <div
      id="search"
      className="animate-blurred-fade-in -z-10 h-svh bg-black/40"
    >
      <section className="relative z-10 flex h-full flex-col items-center justify-center">
        <div className="flex flex-col items-center justify-center gap-4 px-2 lg:gap-6 2xl:gap-8 xl:w-[60rem]">
          ...
          <h1 className="animate-blurred-fade-in animate-delay-100 w-[22rem] text-center text-[35px] leading-none font-black text-green-100 duration-700 sm:w-[40rem] sm:text-[3rem] xl:w-full 2xl:text-6xl">
          ...
          <h2 className="animate-blurred-fade-in animate-delay-200 max-w-[17rem] text-center text-sm text-[#93ffb7] sm:text-lg md:max-w-[50rem] md:text-2xl">
