    ...
    <>
      ...
      >
        <div className="flex flex-col xl:w-[60%]">
          <strong className="text-textsecondary text-center font-telma text-[5rem] sm:text-[7rem]">
            AcuaEs
          </strong>
        ...
        <form className="z-10 my-14 flex max-h-16 w-[17rem] justify-between rounded-xl border-2 border-solid border-slate-400 p-1 text-sm transition-all focus-within:border-blue-300 sm:w-[20rem] sm:text-base md:w-[25rem] md:text-base">
          <Type />
