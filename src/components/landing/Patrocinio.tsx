export default function Patrocinio() {
  return (
    ...
    >
      <div className="animate-wiggle repeat-infinite duration-1000 absolute right-1 top-7 flex w-[7rem] rotate-12 flex-col items-center justify-center gap-1 transition-transform hover:scale-105 md:right-12 md:w-[10rem]">
        <img
          src={"/AGRLogo.webp"}
          width={65}
          height={65}
