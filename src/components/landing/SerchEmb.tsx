  ...
  return (
    <div>
      <form
        ...
        className="bg-[#3f7b7648] relative z-10 mt-8 flex max-h-16 w-[15rem] items-center justify-center rounded-2xl border border-solid border-green-100 p-1 text-sm transition-all focus-within:border-green-200 sm:w-[20rem] sm:text-base md:w-[20rem] md:text-xl"
      >
        <svg
