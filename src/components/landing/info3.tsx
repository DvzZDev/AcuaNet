  ...
  return (
    <section className="section3bg relative flex h-fit items-center justify-center px-6 py-12 md:h-screen">
      <div className="flex w-[45rem] flex-col gap-7 md:gap-16 xl:-mr-[30rem] 2xl:-mr-[50rem]">
        ...
        <article
          ref={ref1}
          className={`${inView1 && "animate-fade-in opacity-100 animate-delay-700 md:animate-delay-0"} rounded-xl bg-black/25 p-5  text-lg leading-relaxed md:leading-relaxed text-emerald-50 opacity-0 backdrop-blur-lg md:text-xl`}
        >
