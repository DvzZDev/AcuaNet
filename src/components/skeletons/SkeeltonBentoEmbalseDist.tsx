...
function EmbalseContent() {
  return (
    <>
      <div className="m-auto h-14 w-[15rem] animate-pulse rounded-lg bg-slate-700 text-center font-NecoBold text-[2.5rem] text-textsecondary sm:mt-10 sm:w-[20rem] sm:text-6xl lg:w-[30rem]"></div>
      <Divider />

      <section className="mb-5 flex min-h-screen justify-center bg-bgcolor p-4 text-white lg:pt-1">
