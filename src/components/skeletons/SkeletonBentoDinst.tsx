function SkeletonBentoDist() {
  return (
    <div className="mx-4 flex min-h-full w-[20rem] animate-pulse flex-col gap-4 sm:grid sm:h-[27rem] sm:w-[40rem] sm:grid-cols-8 sm:grid-rows-8 lg:h-[40rem] lg:w-[60rem]">
      ...
      <div className="col-span-2 row-span-3 rounded bg-[#275e56] transition-all hover:scale-105">
        <article className="flex h-[17rem] flex-col items-center justify-around px-4 sm:h-full">
          <div className="h-[20%] w-[60%] animate-pulse rounded-lg bg-green-200"> </div>
          <div className="h-[40%] w-[60%] animate-pulse rounded-lg bg-green-200"> </div>
          <div className="h-[20%] w-[60%] animate-pulse rounded-lg bg-green-200"> </div>
        </article>
      </div>
      {/* Segunda Columna */}
      ...
      <div className="col-span-2 row-span-3 rounded-lg bg-[#275e56] transition-all hover:scale-105">
        <div className="flex h-full items-center justify-center">
          <div className="w h-32 w-32 animate-pulse rounded-full bg-green-200 sm:h-[70%] sm:w-[70%]"></div>
        </div>
      </div>
      {/* Sexta Columna */}

      <div className="relative col-span-4 row-span-4 overflow-hidden rounded-lg bg-[#275e56] transition-all hover:scale-125">
      ...
      <div className="col-span-2 row-span-3 rounded bg-[#275e56] transition-all hover:scale-105">
        <article className="flex h-[17rem] flex-col items-center justify-around px-4 sm:h-full">
          <div className="h-[20%] w-[60%] animate-pulse rounded-lg bg-green-200"> </div>
          <div className="flex h-[40%] w-[60%] animate-pulse items-center justify-center rounded-lg bg-green-200">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 32 32"
              width={40}
