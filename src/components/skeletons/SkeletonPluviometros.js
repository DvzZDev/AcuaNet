function SkeletonPluviometros() {
  return (
    <div className="mx-10 flex h-[50rem] w-[55rem] animate-pulse items-center justify-center rounded-md bg-slate-500 lg:m-auto">
      <svg
        viewBox="0 0 24 24"
        fill="none"
        width="100"
...
export default SkeletonPluviometros
