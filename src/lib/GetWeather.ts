...
export default async function GetWeather(lat: number, lon: number) {
  ...
  const url = `https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/${lat},${lon}?unitGroup=metric&next7days?elements=datetime%2Ctempmax%2Ctempmin%2Ctemp%2Cwindgust%2Cwindspeed%2Cwindspeedmax%2Cwindspeedmean%2Cwindspeedmin%2Cwinddir%2Cpressure&include=hours%2Cdays%2Cfcst%2Cstatsfcst&key=${key}&contentType=json&iconSet=icons2`
